...
5. **Input Validation**: Manually review inputs or implement additional validation logic if needed.
...
2. Copy the repository content to a new directory in the user's home directory:
   ```bash
...
9. To delete the user, run the following command from a (different) user with sudo privilege:
   ```bash
